...
- **[Boosty](https://boosty.to/legolev)** — разовая помощь или подписка _(укажите свою ссылку)_
- **Крипта** — TON / USDT (TRC-20): адреса на [странице доната](#) _(укажите свою ссылку)_

> _Ссылки на донаты пока плейсхолдеры — замените на свои перед публикацией._
